...
void SoftRenderer::Render2D()
{
    ...
    static constexpr std::array<Vertex2D, vertexCount> rawVertices = {
        Vertex2D(Vector2(-squareHalfSize, -squareHalfSize), {}, Vector2(0.125f,0.75f)),
        Vertex2D(Vector2(-squareHalfSize, squareHalfSize), {}, Vector2(0.125f, 0.875f)),
        Vertex2D(Vector2(squareHalfSize, squareHalfSize), {}, Vector2(0.25f, 0.875f)),
        Vertex2D(Vector2(squareHalfSize, -squareHalfSize), {}, Vector2(0.25f, 0.75f))
    };
